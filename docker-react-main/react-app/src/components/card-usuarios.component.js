...
export default function CardUsuarios({ elson, indexo }) {
    ...
    <div className="container" >
      <div class="card">
        <div key={indexo} class="card-body">
          <h6 class="card-subtitle mb-2 text-body-secondary">Usuario {indexo + 1}</h6>
          <p class="card-text">{elson.id} </p>
          <h6 class="card-subtitle mb-2 text-body-secondary">Nombre</h6>
          <p class="card-text">{elson.nombre} </p>
          <h6 class="card-subtitle mb-2 text-body-secondary">Correo</h6>
          <p class="card-text">{elson.email} </p>
          <h6 class="card-subtitle mb-2 text-body-secondary">Fecha de Nacimiento</h6>
          <p class="card-text">{elson.fecha_nacimiento} </p>
